        ...
        <>
                ...
                <ModalContent>
                    ...
                    <ModalBody>
                        ...
                        >
                            ...
                            <Input disabled={selectedGroupValue?.writable === false} maxWidth="60%" value={valueInputName} paddingLeft="5px" onChange={(event) => setValueInputName(event.target.value)} borderColor="#777a80" _hover={{}} focusBorderColor="#700e17" />
                        </Container>
                        <Container
                            margin="0px"
                            padding="0px"
                        ...
                        <Container padding="10px" borderRadius="6px">
                            <Container padding="0px" width="100%" display="flex" alignItems="center" justifyContent="space-between">
                                <Button isDisabled={selectedGroupValue?.writable === false} _hover={{}} _active={{ bgColor: "#acacac" }} color={colorMode === "dark" ? "#1c222b" : "white"} bgColor={colorMode === "dark" ? "white" : "#1c222b"} onClick={() => setShowADDQuestionsInput(!showADDQuestionsInput)} disabled={selectedGroupValue?.writable === false}>
                            ...
                            <Container borderLeft="1px solid" borderLeftColor={colorMode === "dark" ? "white" : "#1c222b"} marginTop="20px">
                                <OrderedList width="100%">
                                    {questionsInput
                                        .filter(item => item.questionType !== "OBSERVATION")
                                        .map((item, index) => (
                                            <ListItem key={index} id="tasks" color={colorMode === "dark" ? "white" : "#1c222b"} marginBottom="10px" >
                                                <Text _hover={{ cursor: selectedGroupValue?.writable === true ? "pointer" : "not-allowed" }} color={selectedGroupValue?.writable === false ? "#777a80" : colorMode === "dark" ? "white" : "#1c222b"} userSelect="none" onClick={() => selectedGroupValue?.writable === true && handleSelectedQuestionOpen(item)}>
            ...
            <Modal isOpen={isModalRemoveOpen} onClose={handleModalRemoveClose} isCentered>
                ...
                <ModalContent>
                    ...
                    <ModalBody>
                        Você tem certeza que deseja <Text as="span" textDecoration="underline" textDecorationColor="red">excluir esse grupo de questões</Text>?
                        <Text mt={4} color="red">
            ...
            <Modal isOpen={openSelectedQuestion} onClose={handleSelectedQuestionClose} isCentered>
                ...
                <ModalContent>
                    ...
                    <ModalBody>
                        ...
                        <Input borderColor="#777a80" _hover={{}} marginBottom="20px" value={valueNewTitleQuestion} onChange={(event) => setValueNewTitleQuestion(event.target.value)} focusBorderColor="#971520" />
                        <Text fontSize={17}><strong>Descrição:</strong></Text>
                        <Input borderColor="#777a80" _hover={{}} value={valueNewDescQuestion} placeholder="Digite a descrição da pergunta" onChange={(event) => setValueNewDescQuestion(event.target.value)} focusBorderColor="#971520" />
                    </ModalBody>
                    <ModalFooter>
                        <Button colorScheme="red" _hover={{ bg: "#680000" }} marginRight={5} onClick={handleRemoveQuestion}>Apagar Pergunta</Button>
                        <Button bg="green" color={colorMode === "dark" ? "#1c222b" : "white"} _hover={{ bg: "#005a00" }} onClick={handleUpdateQuestion}>Salvar Alterações</Button>
                    </ModalFooter>
                </ModalContent>
            </Modal>
        </>
