...
export default function Autentificacao() {
    ...
    return (
        <div className="body" style={{ backgroundImage: "url(imgs/backgroundlogo.png)", minH: "100vh", display: "flex", alignItems: "center", justifyContent: "center" }}>
            <Container bg="#ffffff" minW="320px" minH="338px" maxW="440px" padding="44px" display="flex" flexDirection="column" justifyContent="space-between">
                ...
                <Container padding="0px">
                    ...
                    <Button onClick={handleClick} marginBottom="20px" bg="transparent" _hover={{bg:"#2758c0FF", color:"#ffffff"}}>Entrar</Button>
                </Container>
                <Container padding="0px">
